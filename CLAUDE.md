...
| **[`docs/plano-produto-hub-casamento.md`](docs/plano-produto-hub-casamento.md)** + **[`docs/fase1-financeiro.md`](docs/fase1-financeiro.md)** + **[`docs/fase2-convidados.md`](docs/fase2-convidados.md)** | O Hub: mapa de módulos e ordem de construção; refinamento completo do Financeiro (Fase 1) e de Convidados — Mesas, Comunicações e os débitos herdados (Fase 2) | Mexer no Financeiro ou em Mesas/Comunicações, ou planejar as próximas fases do Hub |
