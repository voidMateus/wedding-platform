...
| **[`docs/plano-produto-hub-casamento.md`](docs/plano-produto-hub-casamento.md)** + **[`docs/fase1-financeiro.md`](docs/fase1-financeiro.md)** | O Hub: mapa de módulos e ordem de construção; refinamento completo do Financeiro (escopo, modelo de dados, derivações, UI) | Mexer no Financeiro, ou planejar as próximas fases do Hub |
