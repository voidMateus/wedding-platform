...
- **PR4+ — Hero cinematográfico, Ritmo das seções, Cards, Presentes, Motion, Visual Polish, Design Review** (planejado): ver definição completa na seção 22.5 e critério de aceite de cada PR.
