...
// convite (CLAUDE.md, seção 18.2/4.5) — giverName/giverPhone, coletados num
// passo próprio antes da escolha da forma de presentear, são a única
// identificação de quem está presenteando.
//
