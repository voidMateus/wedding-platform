...
-- traduzem junto. Cada bloco: UPDATE dos dados existentes -> drop do CHECK
-- antigo (nome real buscado dinamicamente via pg_constraint, nunca
-- adivinhado — nomes auto-gerados de CHECK inline não seguem rename de
-- tabela/coluna) -> novo CHECK com valores em português.
--
...
-- renomeia o constraint para o nome consistente com a coluna nova.
