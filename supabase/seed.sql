...
insert into convidados (id, casamento_id, convite_id, nucleo_id, ordem_nucleo, nome_completo, email, telefone)
values
  ('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '66666666-6666-6666-6666-666666666666', 0, 'Maria Silva', 'maria@example.com', '+55 11 90000-0001'),
  ('44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '66666666-6666-6666-6666-666666666666', 1, 'Pedro Silva', 'pedro@example.com', '+55 11 90000-0002');
